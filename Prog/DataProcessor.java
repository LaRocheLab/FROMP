...
/*  602:     */       }
/*  603:     */     }
/*  604: 621 */     String Text = "<html><body>Finished processing the samples<br><br>Identified ECs: " + 
/*  605:     */     
/*  606:     */ 
/*  607:     */ 
/*  608: 625 */       Project.amountOfEcs + 
/*  609: 626 */       "<br>" + 
...
/*  620: 637 */     for (int i = 0; i < Project.legitSamples.size(); i++)
/*  621:     */     {
/*  622: 638 */       Text = Text + (i + 1) + ":" + Project.legitSamples.get(i) + " ";
...
/*  647: 662 */     if ((isEc(newEnz[0])) || (isPfambool(newEnz[0]))) {
/*  648: 663 */       ret = true;
/*  649:     */     } else {
